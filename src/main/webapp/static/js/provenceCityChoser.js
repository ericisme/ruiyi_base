...
function InitCitySelect(selProvince,selCity, functionName)
{
    g_selProvince=selProvince;
    g_selCity=selCity;
    //selProvince.onchange=Function("Province_onchange();getGameCentersByProvinceCode(this.value,'s_gamecenterIds');");
    selProvince.onchange=Function("Province_onchange();"+functionName);
