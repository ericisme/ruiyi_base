...
$(document).ready(function(){
  ...
  */
  ...
  {
	  window.location.href="/permission/update/"+permid +"?currentIndex=${currentIndex}";
  }
//-->
</script>
...
<table class="biaoge_1">
  <tr>
    ...
    <td class="biaoge_12">
      菜单名称：
      <input class="text_1" name="menuName" type="text" />
    </td>
  </tr>
  <tr>
...
<c:set var="dir" value="${ctx }/permission/list" scope="request"/>
<jsp:include page="../backEnd/pagination.jsp"/>
</form>
