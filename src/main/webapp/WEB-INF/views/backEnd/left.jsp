...
<script type="text/javascript">
 <!--//
	...
	function todo(url){
/* 		var opts = parent.parent.frames["topFrame"].document.getElementById("_ding_xx_id").getElementsByTagName("option");
		var xx_id = 0;
		...
		if(xx_id == "" || xx_id == "-1"){
			alert("请选择学校!");
			parent.parent.frames["topFrame"].document.getElementById("_ding_xx_id").focus();
			return;
		} */
