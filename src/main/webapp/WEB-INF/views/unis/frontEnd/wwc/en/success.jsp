    ...
    <body>
        ...
        <div class="container">
            <div class="header">
                ...
                <h2 class="clearfix signup-heading">Successful!</h2>
            </div>
            ...
            <div class="overlap">
                <div class="primary-content">
                  <div class="bs-callout bs-callout-info">
                    ...
                    <h4>Registration is successful!</h4>
                    <p class="text-info">After your registration has been submitted, the system will generate a QR code which we will send to you by email.
                    Please save the QR code to your mobile device or print out a copy as it will be scanned as your admission ticket when you enter the conference.
                   </p>
                  ...
                  <a href="/wwc/index" class="btn btn-info btn-block btn-lg">UNIS GLobal Partner's Expo</a>
                </div> <!-- /.primary-content -->
            </div> <!-- /.overlap -->
