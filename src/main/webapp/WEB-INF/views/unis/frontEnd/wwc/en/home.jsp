        ...
        <![endif]-->
          ...
          <section class="landing">
            <div class="container">
              ...
              <div class="logo animated bounceIn animateDelay1">   <a href="/">
              <img src="/static/wwc/img/logo.png" alt="" width="220">
              </a></div>
              <div id="languageselect" class="language btn-group pull-right">
                <a rel="0" class="btn btn-default active">EN</a>
                <a rel="1" class="btn btn-default">中 文</a>
              </div>
              <div id="animated_" class="animated bounceInDown">
                <h1>UNIS Global Partner's Expo</h1>
                <h4>UNITE, INSPIRE, INNOVATE, SURPASS</h4>
              </div>
                ...
                <div class="col-sm-5 col-md-4 col-sm-offset-1">
                  <form role="form" action="/wwc/invitation_code/verify" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control unis-form" id="invitation" name="invitationCode" placeholder="invitation code">
                    </div>
                    <div class="form-group">
                      <label for="invitation">Auth code</label>
                      <div class="row">
                        <div class="col-xs-6">
                          <input type="text" class="form-control unis-form" id="authcode" name="captcha" placeholder="auth code">
                        </div>
                        <div class="col-xs-6">
                    ...
                    <button type="submit" class="btn btn-default btn-block unis-btn">Apply Now</button>
                  </form>

                 <!--  <div class="get-inviation"><a href="/wwc/applycode">apply an invitation code</a></div> -->
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="event-where text-center">
                    <h3>Where</h3>
                    <p>ZhongShan, China</p>
                    <a href="http://goo.gl/maps/Mah03" target="_blank" class="btn btn-default btn-info">view on Google Maps</a>
                  </div>
                </div>
              </div> <!-- /.row -->
            </div><!-- /.container -->
                          ...
                          <div class="col-sm-5">
                            <div href="#" class="article_thumbnail">
                              ...
                              <div class="category text-center">
                                <a href="#"><span class="badge-list badge">${item.tagEnglish}</span></a>
                              </div>
                            </div>
                          </div>
                          <div class="col-sm-7">
                            <a class="frame-article fancybox.iframe" href="/wwc/article/${item.id }">
                              <h3>${item.title }</h3>
                              <p name="news_content">
                              <c:if test="${fn:length(item.contentWithoutHtml) > 100}">${fn:substring(item.contentWithoutHtml,0,100) }......</c:if>
                               <c:if test="${fn:length(item.contentWithoutHtml) <= 100}">${item.contentWithoutHtml}</c:if>
                              </p>
                            </a>
                          </div>
                        </div> <!-- /.article-pre -->
