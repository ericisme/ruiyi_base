...
<script src="${ctx }/static/js/base/CookieUtils.js"></script>
<script>
<!-- 2014-06-26改名字成 游币-->

	var sycoin = ${entity.sycoin};
	...
	$(document).ready(function() {
		...
		*/
		...
		/*
			重定向的时候，刷新价格
		*/
		$('#rechargePrice').html(FormatNumber(sycoin * discount, 2));
	...
	*/
	...
	function onkeyUP() {
		$('#rechargePrice').html(FormatNumber($('#sycoin').val() * discount, 2));
	}
	function onChange() {
		var sycoin = $('#sycoin').val();
		if (isNaN(sycoin)) {
			...
			$('#czMountP').addClass('text-danger');
			$('#sycoin').val(0);
			$('#rechargePrice').html($('#sycoin').val());
			return false;
		} else {
			if (sycoin % 10 != 0 || sycoin<=0) {
				$('#czMountDiv').addClass('has-error');
				$('#czMountP').addClass('text-danger');
				$('#sycoin').val(0);
			}else{
	...
	<div class="row">
		...
		<div class="col-sm-4 col-md-3">
			...
			<div class="list-group">
				<a href="${ctx}/frontEnd/alipay/sycoin" class="list-group-item active">游币充值</a>
				<a href="${ctx}/frontEnd/alipay/token" class="list-group-item">实体币充值</a>
			</div>
				...
				<div class="row">
					<div class="col-sm-8">
						<form role="form" id="formCZ" name="formCZ"
							...
							<input type="hidden" id="rechargetype" name="rechargetype" value="sycoin"/>
							<div class="form-group">
								<label for="czNumber">充值手机号:</label> <input type="text"
							...
							<div class="form-group " id="czNumberErrorDiv">
								<label for="czNumber">再次输入手机号:</label> <input type="text"
									...
									value="${entity.confirmusername }">

										<span id="czNumberErrorSpan"
							 ...
							 <div id="sycoin_recharge_mount">
								...
								<div class="form-group">
									<label>充值数量<small> ( 1游币 = 1元人民币 ):</small></label>
									<div class="clearfix"></div>
									<div class="radio-inline">
										<label> <input type="radio" name="czMountRadio"
											id="optionsCZ1" class="mount" value="10"
											<c:if test="${entity.isChecked==10 }">checked</c:if>>10游币
										</label>
									</div>
									<div class="radio-inline">
										<label> <input type="radio" name="czMountRadio"
											id="optionsCZ2" class="mount" value="30"
											<c:if test="${entity.isChecked==30 }">checked</c:if>>30游币
										</label>
									</div>
									<div class="radio-inline">
										<label> <input type="radio" name="czMountRadio"
											id="optionsCZ3" class="mount" value="50"
											<c:if test="${entity.isChecked==50 }">checked</c:if>>50游币
										</label>
									</div>
									<div class="radio-inline">
										<label> <input type="radio" name="czMountRadio"
											id="optionsCZ4" class="mount" value="100"
											<c:if test="${entity.isChecked==100 }">checked</c:if>>100游币
										</label>
									</div>
									<div id="czMountDiv">
										<label for="optionsCZother">其他:</label> <input
											onkeyup="onkeyUP();" onchange="onChange();"
											onblur="onChange();" onmouseout="onChange();" type="text"
											name="sycoin" value="${entity.sycoin }" id="sycoin"
											class="form-control otherInput"> 游币
										<p id="czMountP">* 充值数量必须为10的正倍数</p>
									</div>
								</div>

							</div>

							<div id="token_recharge_mount" class="hidden">

								<div class="form-group">
									<div id="token_recharge_mount_div">
										<label for="optionsCZother">数量:</label> <input
											name="token" value="${entity.token }" id="token"
											class="form-control otherInput"> 游戏币
										<p id="token_recharge_mount_p">* 充值数量必须为10的正倍数</p>
									</div>
								</div>
