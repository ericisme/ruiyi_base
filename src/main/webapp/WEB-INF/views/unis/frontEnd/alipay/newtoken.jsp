						...
						<form role="form" id="formCZ" name="formCZ"
							...
							<div class="form-group " id="czNumberErrorDiv">
							 ...
							 <div id="sycoin_recharge_mount">
								...
								<div class="form-group">
									<label>充值数量<small> ( 1实体币 = 1元人民币 ):</small></label>
									<div class="clearfix"></div>
									<div class="radio-inline">
										<label> <input type="radio" name="czMountRadio"
											id="optionsCZ1" class="mount" value="10"
											<c:if test="${entity.isChecked==10 }">checked</c:if>>10实体币
										</label>
									</div>
									<div class="radio-inline">
										<label> <input type="radio" name="czMountRadio"
											id="optionsCZ2" class="mount" value="30"
											<c:if test="${entity.isChecked==30 }">checked</c:if>>30实体币
										</label>
									</div>
									<div class="radio-inline">
										<label> <input type="radio" name="czMountRadio"
											id="optionsCZ3" class="mount" value="50"
											<c:if test="${entity.isChecked==50 }">checked</c:if>>50实体币
										</label>
									</div>
									<div class="radio-inline">
										<label> <input type="radio" name="czMountRadio"
											id="optionsCZ4" class="mount" value="100"
											<c:if test="${entity.isChecked==100 }">checked</c:if>>100实体币
										</label>
									</div>
									<div id="czMountDiv">
										<label for="optionsCZother">其他:</label> <input
											...
											class="form-control otherInput"> 实体币
