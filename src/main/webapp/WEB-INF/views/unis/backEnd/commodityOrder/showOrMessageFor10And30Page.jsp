...
<div class="weizhi">你的位置是：商城管理>> 订单管理 >> 查看<shiro:hasPermission name="commodityOrder:deliveryOut">/留言</shiro:hasPermission>
</div>
		...
		<tr>
			<th colspan="4" class="t_title t_c">
				<shiro:hasPermission name="commodityOrder:deliveryOut">
					<input type="button" class="button_3" id="save_btn" name="" value="留言" onclick="excuteMessageFor10Or30();"/>			
