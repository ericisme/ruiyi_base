...
<div class="weizhi">你的位置是：商城管理>> 订单管理 >> 发货
</div>
...
<form name="mainForm" id="mainForm">
	...
	<table class="biaoge_3" style="margin-top:10px;">		
		...
		<tr>
				...
				<th class="biaoge_32" style="width:10%">留言</th>				
			</tr>
	...
	<table class="biaoge_3" style="margin-top:10px;">		
		...
		<tr>	
			...
			<td class="biaoge_33" style="width:80%" >
				<select id="commodityLogistics_id" name="commodityLogistics_id">
					<option value="">---请选择---</option>
					<c:forEach items="${allEnableCommodityLogistic }" var="commodityLogistic"   varStatus="status1">
						<option value="${commodityLogistic.id }">${commodityLogistic.name }</option>
					</c:forEach>
				</select>
			</td>
		</tr>
		<tr>
			...
			<td class="biaoge_33" style="width:80%" >
				<input type="text"  id="logisticsCode"  name="logisticsCode"  size="50" maxlength="50"/>
			</td>
		</tr>
	</table>
		...
		<tr>
			<th colspan="4" class="t_title t_c">
				<shiro:hasPermission name="commodityLogistics:edit">
					<input type="button" class="button_3" id="save_btn" name="" value="发货" onclick="excuteDeliveryOut();"/>			
