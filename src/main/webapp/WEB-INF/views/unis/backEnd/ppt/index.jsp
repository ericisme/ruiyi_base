...
<script type="text/javascript" src="${ctx }/static/js/unis/backEnd/ppt/ppt.js"></script>
...
<body>
	<div id="head">
	<div class="weizhi" >你的位置是：主页管理 >> 幻灯片管理</div>
		<table class="biaoge_1" style="margin-top:10px;">
			...
			<tr>
				...
				<td class="biaoge_12">
					<input type="button" class="button_1" name="" value="查询" onclick="pptQuery();"/> 
