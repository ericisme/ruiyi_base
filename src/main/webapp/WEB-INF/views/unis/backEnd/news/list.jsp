		...
		<c:otherwise>
			<c:forEach items="${page }" var="entity" varStatus="status">
				...
				<tr class="biaoge_22" ondblclick="show(${entity.id});" style="cursor:pointer">
					...
					<td title="双击查看">${entity.tagChinese  }</td>
					<td title="双击查看">${entity.title  }</td>
					<td title="双击查看">${entity.author }</td>
					<td title="双击查看"><fmt:formatDate value="${entity.addTime}" pattern="yyyy-MM-dd" /></td>
					...
					<td>
					    ...
					    <shiro:hasPermission name="news:setup">
