...
<div class="weizhi">你的位置是：主页管理>> 新闻管理 >>
...
<form name="mainForm" id="mainForm">
	<table class="biaoge_3" style="margin-top:10px;">
		...
		<tr>
			<td class="biaoge_32" style="width:15%">
				标题图片地址<br>请用分辨率 170x170 的图片
			</td>
			<td class="biaoge_33" style="width:35%">
				<input type="text" class="text_4" name="titleImg" id="titleImg"  value="${entity.titleImg }" maxlength="200" /><font color="red"  id="tips"></font>
			</td>
			<td class="biaoge_32" style="width:15%">
				标题图片-预览
			</td>
			<td class="biaoge_33" style="width:35%" colspan="3">
				<img src="${entity.titleImg }" width="60" height="60"/>
			</td>
		</tr>
		<tr>
			<td class="biaoge_31" colspan="4">
